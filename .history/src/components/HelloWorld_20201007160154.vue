<template>
  <div class="hello">
    ...
    <ol>
      <li v-for="user in filterUsers_" :key="user.id">
        <div>
          {{ user.name }}
        </div>
      </li>
...
export default {
  ...
  computed: {
    ...mapState(['message', 'username', 'limitationList']),
    ...mapGetters(['welcomeMessage', 'users', 'filterUsers_'])
  },
  methods: {
    ...mapActions(['updateUserName', 'fetchUsers', 'setFilterUsers']),
